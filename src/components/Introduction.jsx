    ...
    <div  className='bg-white p-5 border-b-[1px] border-x-[1px] border-gray-300 rounded-b-2xl'>
        <div className='mt-20 px-5 lg:grid lg:grid-cols-2 gap-x-5'>
            <div>
                ...
                <p className='flex justify-start items-center gap-2 flex-wrap'>Dynamic Frontend Developer | <FaReact className='inline-block'/> React JS, <SiRedux className='inline-block'/>Redux Toolkit, <RiTailwindCssFill className='inline-block'/> Tailwind</p>
                <p className='text-[#0009]'>Aligarh, Uttar Pradesh, India</p>
            </div>
            <div>
            <div className='flex justify-start lg:justify-end items-center gap-x-3 mt-5 lg:mt-0'>
